...
// This symbol is generated by ESP-IDF when embedding binary files
#ifdef USE_ESP32_VARIANT_ESP32C6
extern "C" const uint8_t lp_firmware_bin_start[] asm("_binary_hcp2_lp_bin_start");
extern "C" const uint8_t lp_firmware_bin_end[]   asm("_binary_hcp2_lp_bin_end");
#endif
...
void HCPBridge::setup() {
  ...
  size_t size = lp_firmware_bin_end - lp_firmware_bin_start;
  esp_err_t err = ulp_lp_core_load_binary(lp_firmware_bin_start, size);
  if (err != ESP_OK) {
